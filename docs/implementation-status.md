...
This is the historical foundation report. Current implementation and local verification are documented in [Phase 8](phase-8.md), [Phase 9](phase-9.md), [Phase 10](phase-10-free-voice.md), and [Phase 11](phase-11-product-shell.md); the original environment limitations below are historical.
